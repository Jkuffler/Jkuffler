...
Ruby/Rails RESTful API designed to display on React front-end a random national park. User creates session to log visits to national park. CRUD available for visits in user passport.
